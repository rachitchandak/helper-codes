...
exports.isResolvedColor = isResolvedColor;
...
function isColorValue(value) {
    ...
    if (trimmed === 'transparent')
        return true;
    if (HEX_3_RE.test(trimmed) || HEX_6_RE.test(trimmed) || HEX_8_RE.test(trimmed))
        return true;
...
function normalizeColor(raw) {
    ...
    if (hslMatch) {
        ...
        if (a === 0)
            return 'transparent';
        const [r, g, b] = color_convert_1.default.hsl.rgb([h, s, l]);
        return rgbToHex(r, g, b);
    }
 ...
 */
function isResolvedColor(value) {
