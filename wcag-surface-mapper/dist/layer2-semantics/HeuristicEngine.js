...
exports.SemanticHeuristicEngine = void 0;
class SemanticHeuristicEngine {
    classify(file, framework, ast) {
        const surfaces = [];
        const traverse = (node) => {
    ...
    applyRules(node) {
        ...
        // 1️⃣ IMAGE_SURFACE
        if (['img', 'picture', 'svg', 'canvas', 'image', 'imageview'].includes(tag) ||
...
exports.SemanticHeuristicEngine = SemanticHeuristicEngine;
